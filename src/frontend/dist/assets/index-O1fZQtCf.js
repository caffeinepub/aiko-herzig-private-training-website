...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-8 tracking-tight text-center", children: "About" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 md:gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/5] rounded-sm overflow-hidden shadow-subtle animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-muted-foreground leading-relaxed animate-fade-in", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Aiko Herzig has developed her practice over more than fifteen years, integrating strength training, therapeutic movement, and manual bodywork. Through a powerful blend of fascia release, breath work, emotional processing, and movement-based alignment, we regulate the nervous system, release stored trauma, and reconnect to the body." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Her work has included long-term collaboration with athletes, performing artists, and individuals recovering from injury or managing chronic conditions. These varied contexts have shaped a precise, sustainable approach to physical development and recovery. Based on deep embodiment, years of study, and walking through her own healing, it's a full-body transformation." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Professional education includes advanced training in strength and conditioning, manual therapy, and movement assessment. Applying naturopathy, TCM and ongoing study are regarded as integral to her work." })
      ] })
    ] })
  ] }) });
}
function Confidentiality() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "confidentiality", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-6 tracking-tight text-center", children: "Confidentiality" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground leading-relaxed text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Discretion is absolute." }) })
  ] }) }) });
}
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-3xl text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-8 tracking-tight", children: "Contact" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground leading-relaxed animate-fade-in space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Inquiries by referral." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Please include a brief outline of goals and availability." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Responses within 48 hours." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "pt-2", children: "Email: aikoherzig@proton.me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Phone: +43 660 169 9065" })
    ] })
  ] }) });
}
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "py-12 px-6 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-4xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-2 text-sm text-muted-foreground text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Aiko Herzig — Private Training © 2026" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Email: aikoherzig@proton.me" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Phone: +43 660 169 9065" })
  ] }) }) });
}
function Foundations() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "foundations", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-8 tracking-tight text-center", children: "Foundations" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-muted-foreground leading-relaxed animate-fade-in text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A refined, evidence-informed approach to strength training, manual therapy, and movement assessment, thoughtfully integrating naturopathic principles and acupressure." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Where appropriate, sessions may support post-clinical continuity of care, guided by clear and respectful professional boundaries." })
    ] })
  ] }) });
}
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center justify-center px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          backgroundImage: "url(/assets/generated/geometric-pattern.dim_1200x800.jpg)",
          backgroundSize: "cover",
          backgroundPosition: "center"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-4xl mx-auto text-center animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl md:text-7xl lg:text-8xl font-serif font-light mb-6 tracking-tight", children: "Aiko Herzig" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 md:gap-4 text-base md:text-lg text-muted-foreground mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Private Training" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Bodywork" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Recovery" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base text-muted-foreground italic", children: "(By referral)" })
    ] })
  ] });
}
function Location() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "location", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-8 tracking-tight text-center", children: "Locations" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 md:gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-muted-foreground leading-relaxed animate-fade-in", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground mb-1", children: "Studio Belvedere" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Prinz Eugen Straße 48/ 1-2, 1040 Vienna, Austria" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground mb-1", children: "Penthouse Sports" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Johannesgasse 25, 1010 Vienna, Austria" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground mb-1", children: "Clinicus Natura" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Rua do Raio nº26, Braga, Portugal" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Off location, travel and via Zoom may be available upon request." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/5] rounded-sm overflow-hidden shadow-subtle animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
...
function Practice() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "practice", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-6 tracking-tight text-center", children: "Practice" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground leading-relaxed text-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "One-to-one work integrating strength training, therapeutic movement, and manual bodywork." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Sessions are adaptive rather than programmatic, guided by ongoing assessment and direct response to the body's condition on the day. Precision, restraint, and continuity shape the work." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Progress is reflected in durability, ease of movement, and resilience over time." })
    ] })
  ] }) }) });
}
function Session() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "session", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-10 tracking-tight", children: "Session" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left space-y-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-serif font-light tracking-widest uppercase mb-5 text-muted-foreground", children: "Austria" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "60 min." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-light", children: "€250" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "90 min." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-light", children: "€280" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/40 pt-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-serif font-light tracking-widest uppercase mb-1 text-muted-foreground", children: "At Penthouse Sports 1010, Vienna" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-serif font-light tracking-wide mb-4", children: "Private sessions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-lg", children: "Each session is designed around your body, your pace, and your goals, never a template." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0 divide-y divide-border/30 max-w-xl", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif font-light text-foreground mb-1", children: "Suspension & functional training" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Precision movement, postural work, and strength using suspension" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-light text-foreground whitespace-nowrap pt-0.5", children: "€ 130" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif font-light text-foreground mb-1", children: "Osteopathic face & neck treatment" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Targeted release work for the face, jaw, and cervical spine. Deeply restorative." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-light text-muted-foreground whitespace-nowrap pt-0.5 text-sm", children: "€ 60 add-on" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif font-light text-foreground mb-1", children: "Deep tissue massage & reflexology" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Structural bodywork combined with reflex point therapy for full-body recovery." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-light text-muted-foreground whitespace-nowrap pt-0.5 text-sm", children: "€ 60 add-on" })
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-light tracking-widest uppercase text-muted-foreground mb-4 block", children: "Recommended" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start gap-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif font-light text-foreground text-lg mb-1", children: "Full session" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Suspension training + your choice of massage therapy — the complete experience." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right whitespace-nowrap pt-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif font-light text-foreground text-lg", children: "€ 250" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "per session" })
                ] })
              ] })
            ]
          }
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Session, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Foundations, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Location, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Confidentiality, {}),
