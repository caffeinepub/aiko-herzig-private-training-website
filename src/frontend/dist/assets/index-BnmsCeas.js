...
function Session() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "session", className: "py-16 md:py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-serif font-light mb-6 tracking-tight", children: "Session" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl md:text-5xl font-serif font-light tracking-tight mb-8", children: "€250" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-8", children: "All-in-one session, tailored to the individual." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-muted-foreground leading-relaxed", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Suspension Yoga & Pilates" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Deep Tissue / Bodywork" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Osteo Face Lift Massage" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Acupressure" })
    ] })
  ] }) }) });
}
function App() {
